...
## [0.14.2](https://github.com/sevki/cel-rust/compare/v0.14.1...v0.14.2) - 2026-07-31

### Added

- *(cps)* add try_step! and pipeline! macros
- *(cps)* add continuation-passing-style evaluation, demo, and tests

### Fixed

- *(cps)* factor boxed continuation into a type alias
